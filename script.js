...
function updateAllQuadrantsByDate() {
  ...
  quadrants.forEach(quadrant => {
    ...
    // Clear existing lessons and reload CSV to reflect the new date's course
    quadrant.lessons = [];
